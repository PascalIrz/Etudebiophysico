...
ggplot(verif_fraction,
  ...
  labs(title = "Méthode d'analyse Nitrates",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
...
ggplot(verif_fraction_ammonium,
  ...
  labs(title = "Méthode d'analyse Ammonium",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
...
ggplot(verif_fraction_nitrites,
  ...
  labs(title = "Méthode d'analyse Nitrites",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
...
ggplot(verif_fraction_po4,
  ...
  labs(title = "Méthode d'analyse orthophosphates",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
...
ggplot(verif_fraction_poT,
  ...
  labs(title = "Méthode d'analyse Phosphore total",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
...
ggplot(verif_fraction_mes,
  ...
  labs(title = "Méthode d'analyse MES",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
...
ggplot(verif_fraction_cond,
  ...
  labs(title = "Méthode d'analyse conductivité",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
...
ggplot(verif_fraction_orga,
  ...
  labs(title = "Méthode d'analyse Carbone organique",
       x = "Date",
       y = "Station",
       fill = "Score") +
  theme_classic()
