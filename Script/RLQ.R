...
# if (exists("degraded_stations_sorted") && nrow(degraded_stations_sorted) > 0) {
#   text(degraded_stations_sorted, labels = rownames(degraded_stations_sorted), cex = 0.7, pos = 3, col = "red")
# }
...
# if (exists("taxons_degraded_conditions_sorted") && nrow(taxons_degraded_conditions_sorted) > 0) {
#   text(taxons_degraded_conditions_sorted, labels = rownames(taxons_degraded_conditions_sorted), cex = 0.7, pos = 1, col = "red")
# }
